...
<head>
    ...
    <title>Μελισσοκομική Επιχείρηση</title>
...
<div class="container" id="about">
    <h2>Βιογραφικό της Επιχείρησης</h2>
    <p>Εδώ θα περιγράψετε την ιστορία της επιχείρησής σας, τις αξίες και τους στόχους σας.</p>
</div>
...
<div class="container" id="products">
    ...
    <div class="products">
        <div class="product">
            <h3>Θυμαρίσιο Μέλι</h3>
            <p>Περιγραφή του θυμαρίσιου μελιού.</p>
        </div>
        <div class="product">
            <h3>Μέλι Ερείκης</h3>
            <p>Περιγραφή του μελιού ερείκης.</p>
        </div>
